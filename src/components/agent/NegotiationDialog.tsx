                        ...
                        {negotiation.strategy_impact_map.heat_zones.slice(0, 8).map((z: any, idx: number) => (
                          <div
                            ...
                            className={cn(
                              ...
                              z.bottleneck_node ? 'border-gate-reject-border bg-gate-reject/40' : 'bg-muted/20'
                            )}
                          >
                            <div className="min-w-0">
                              <div className="text-sm font-medium truncate">
                                {z.segment_id}
                                {z.bottleneck_node ? <span className="ml-2 text-xs text-gate-reject-foreground">物理瓶颈</span> : null}
                              </div>
                              {z.criterion ? (
